...
from app.services.tracking_simulator import simulation_loop


@asynccontextmanager
async def lifespan(app: FastAPI):
    # Create tables and seed demo data on startup. In a real deployment this
    # would be replaced by Alembic migrations run as a separate step.
    init_db()

    # Start the dummy GPS simulator loop as a background task.
